...
/**
 * Client-side wrapper that imports NAV_CONFIG.REFEREE on the client side.
 ...
 */
export function RefereeShell({ user, children }: { user: DashUser; children: React.ReactNode }) {
  const navItems: NavItem[] = NAV_CONFIG.REFEREE;
