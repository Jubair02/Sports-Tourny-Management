...
/**
 * Client-side wrapper that imports NAV_CONFIG.TEAM_MANAGER on the client side.
 ...
 */
export function TeamShell({ user, children }: { user: DashUser; children: React.ReactNode }) {
  const navItems: NavItem[] = NAV_CONFIG.TEAM_MANAGER;
